...
const ProceduralGroundBackground: React.FC = () => {
    ...
    // Removed bg-zinc-950 to allow transparency if needed, or keeping it as the base.
    // The user wants this as the background for the app.
    return (
        <div className="fixed inset-0 w-full h-full bg-[#030303] -z-10">
            <canvas
                ref={canvasRef}
